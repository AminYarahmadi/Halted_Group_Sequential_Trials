...
do_simulation <- function(sim=1, look_size, org_uppers, sprt_org_uppers, remaining_uppers, sprt_remaining_uppers, seed){
  ...
  #print(stopping_look)
  observed_statistic = statistic_calculator(look_size, stopping_look-1, 0)
...
plot(xdata[order(xdata)], y1[order(xdata)], type = "o", pch = 1, col = "blue", lty=1, xlab = "Look", ylab = "Type I error spent", ylim=c(0,0.03))
